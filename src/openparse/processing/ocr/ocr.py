...
from src.openparse.processing.ocr.postprocess import build_post_process
        ...
        if not model_dir:
            try:
                model_dir = os.path.join(
                    ...
                    "src/openparse/processing/model")
...
if __name__ == '__main__':
    fnm = "/Users/chenxu/workspace/python3/flask-demo/flask-demo/src/pdf/Snipaste_2024-04-29_15-15-03.png"
    ocr = OCR()
    bxs = ocr(np.array(Image.open(fnm)))
